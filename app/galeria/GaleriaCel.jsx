...
function GaleriaCel() {
  ...
  return (
    <div className="relative bg-black w-full min-h-screen flex items-center justify-center overflow-hidden py-12 sm:py-16 md:py-20">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <motion.div
          ...
          className="rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl mx-auto max-w-5xl"
        >
          <Swiper
